...
check_no_import internal/protocol '"net/http"' 'internal/protocol must not import http'
...
check_no_import internal/protocol 'github.com/dimbo1324/ttron-ttr20-time-r/internal/app' 'internal/protocol must not import internal/app'
